...
public class ExtensionLoader<T> {
    ...
    private static final String SERVICES_DIRECTORY = "META_INF/services/";
    private static final String LEARN_DIRECTORY = "META-INF/learn/";
    private static final String LEARN_DIRECTORY_EXTERNAL = "META-INF/learn/external/";
    private static final String LEARN_DIRECTORY_INTERNAL = "META-INF/learn/internal/";
    private static final String[] SPI_DIRECTORIES = new String[]{
            SERVICES_DIRECTORY,
            LEARN_DIRECTORY,
            LEARN_DIRECTORY_EXTERNAL,
            LEARN_DIRECTORY_INTERNAL
    };
    ...
    public T getSpiClassInstance(final String name) {
        if (StringUtils.isBlank(name)) {
            throw new NullPointerException("get si class name is null");
        }
